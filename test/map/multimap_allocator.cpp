...
TEST(MultimapUneqAllocMove, Test1)
{
    ...
    using test_type = multimap<test::T, test::U, compare_three_way, alloc_type>;
...
TEST(MultimapUneqAllocMoveAssign, Test1)
{
    ...
    using test_type = mstd::multimap<test::T, test::U, compare_three_way, alloc_type>;
    test_type v1(alloc_type(1));
    v1 = {test_type::value_type{}};
...
TEST(MultimapUneqAllocMoveAssign, Test3)
{
    ...
    using test_type = multimap<int, int, compare_three_way, alloc_type>;
