...
// This is deliberately different than MSTD_STD_VER to discourage matching them up.
#endif
#endif
...
#ifdef MSTD_USE_FROZEN_CXX03_HEADERS
#  ifdef MSTD_HAS_NO_ALIGNED_ALLOCATION
#    define TEST_HAS_NO_ALIGNED_ALLOCATION
#  endif
#elif defined(MSTD_VERSION) && !MSTD_HAS_ALIGNED_ALLOCATION
#  define TEST_HAS_NO_ALIGNED_ALLOCATION
...
#elif !defined(MSTD_VERSION) || MSTD_AVAILABILITY_HAS_FROM_CHARS_FLOATING_POINT
...
#if defined(MSTD_VERSION) && !MSTD_HAS_WIDE_CHARACTERS
#  define TEST_HAS_NO_WIDE_CHARACTERS
#endif

#if defined(MSTD_VERSION) && !MSTD_HAS_UNICODE
...
#ifdef MSTD_USE_FROZEN_CXX03_HEADERS
#  ifdef MSTD_HAS_OPEN_WITH_WCHAR
#    define TEST_HAS_OPEN_WITH_WCHAR
#  endif
#elif defined(MSTD_VERSION) && MSTD_HAS_OPEN_WITH_WCHAR
#  define TEST_HAS_OPEN_WITH_WCHAR
#endif

#ifdef MSTD_USE_FROZEN_CXX03_HEADERS
#  ifdef MSTD_HAS_NO_INT128
#    define TEST_HAS_NO_INT128
#  endif
#elif (defined(MSTD_VERSION) && !MSTD_HAS_INT128) || defined(_MSVC_STL_VERSION)
#  define TEST_HAS_NO_INT128
#endif

#if defined(MSTD_VERSION) && !MSTD_HAS_LOCALIZATION
...
#if defined(MSTD_VERSION) && !MSTD_HAS_THREADS
#  define TEST_HAS_NO_THREADS
#endif

#if defined(MSTD_VERSION) && !MSTD_HAS_FILESYSTEM
#  define TEST_HAS_NO_FILESYSTEM
#endif

#ifdef MSTD_USE_FROZEN_CXX03_HEADERS
#  ifdef MSTD_HAS_NO_C8RTOMB_MBRTOC8
#    define TEST_HAS_NO_C8RTOMB_MBRTOC8
#  endif
#elif defined(MSTD_VERSION) && !MSTD_HAS_C8RTOMB_MBRTOC8
#  define TEST_HAS_NO_C8RTOMB_MBRTOC8
#endif

#if defined(MSTD_VERSION) && !MSTD_HAS_RANDOM_DEVICE
...
#elif defined(MSTD_VERSION) && !MSTD_HAS_EXPERIMENTAL_TZDB
#  define TEST_HAS_NO_EXPERIMENTAL_TZDB
#endif

#if defined(MSTD_VERSION) && !MSTD_HAS_TIME_ZONE_DATABASE
...
#ifdef MSTD_SHORT_WCHAR
#  define TEST_SHORT_WCHAR
#endif

#ifdef MSTD_ABI_MICROSOFT
