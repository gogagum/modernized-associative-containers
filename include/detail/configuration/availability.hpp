...
#ifndef MSTD_CONFIGURATION_AVAILABILITY_HPP
#define MSTD_CONFIGURATION_AVAILABILITY_HPP
...
//
// We also allow users to force-disable availability markup via the `MSTD_DISABLE_AVAILABILITY`
...
#if defined(MSTD_BUILDING_LIBRARY) || defined(_LIBCXXABI_BUILDING_LIBRARY) ||                                       \
    !defined(MSTD_COMPILER_CLANG_BASED) || defined(MSTD_DISABLE_AVAILABILITY)
#  undef MSTD_HAS_VENDOR_AVAILABILITY_ANNOTATIONS
#  define MSTD_HAS_VENDOR_AVAILABILITY_ANNOTATIONS 0
#endif

// When availability annotations are disabled, we take for granted that features introduced
// in all versions of the library are available.
#if !MSTD_HAS_VENDOR_AVAILABILITY_ANNOTATIONS

#  define MSTD_INTRODUCED_IN_LLVM_22 1
#  define MSTD_INTRODUCED_IN_LLVM_22_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_21 1
#  define MSTD_INTRODUCED_IN_LLVM_21_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_20 1
#  define MSTD_INTRODUCED_IN_LLVM_20_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_19 1
#  define MSTD_INTRODUCED_IN_LLVM_19_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_18 1
#  define MSTD_INTRODUCED_IN_LLVM_18_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_16 1
#  define MSTD_INTRODUCED_IN_LLVM_16_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_15 1
#  define MSTD_INTRODUCED_IN_LLVM_15_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_14 1
#  define MSTD_INTRODUCED_IN_LLVM_14_ATTRIBUTE /* nothing */

#  define MSTD_INTRODUCED_IN_LLVM_12 1
#  define MSTD_INTRODUCED_IN_LLVM_12_ATTRIBUTE /* nothing */
...
// LLVM 22
// TODO: Fill this in
#  define MSTD_INTRODUCED_IN_LLVM_22 0
#  define MSTD_INTRODUCED_IN_LLVM_22_ATTRIBUTE __attribute__((unavailable))

// LLVM 21
// TODO: Fill this in
#  define MSTD_INTRODUCED_IN_LLVM_21 0
#  define MSTD_INTRODUCED_IN_LLVM_21_ATTRIBUTE __attribute__((unavailable))
...
#    define MSTD_INTRODUCED_IN_LLVM_20 0
#  else
#    define MSTD_INTRODUCED_IN_LLVM_20 1
#  endif
#  define MSTD_INTRODUCED_IN_LLVM_20_ATTRIBUTE                                                                 \
...
#    define MSTD_INTRODUCED_IN_LLVM_19 0
#  else
#    define MSTD_INTRODUCED_IN_LLVM_19 1
#  endif
#  define MSTD_INTRODUCED_IN_LLVM_19_ATTRIBUTE                                                                 \
...
#    define MSTD_INTRODUCED_IN_LLVM_18 0
#  else
#    define MSTD_INTRODUCED_IN_LLVM_18 1
#  endif
#  define MSTD_INTRODUCED_IN_LLVM_18_ATTRIBUTE                                                                 \
...
#    define MSTD_INTRODUCED_IN_LLVM_16 0
#  else
#    define MSTD_INTRODUCED_IN_LLVM_16 1
#  endif
#  define MSTD_INTRODUCED_IN_LLVM_16_ATTRIBUTE                                                                 \
...
#    define MSTD_INTRODUCED_IN_LLVM_15 0
#  else
#    define MSTD_INTRODUCED_IN_LLVM_15 1
#  endif
#  define MSTD_INTRODUCED_IN_LLVM_15_ATTRIBUTE                                                                 \
...
// LLVM 14
#  define MSTD_INTRODUCED_IN_LLVM_14 MSTD_INTRODUCED_IN_LLVM_15
#  define MSTD_INTRODUCED_IN_LLVM_14_ATTRIBUTE MSTD_INTRODUCED_IN_LLVM_15_ATTRIBUTE
...
#    define MSTD_INTRODUCED_IN_LLVM_12 0
#  else
#    define MSTD_INTRODUCED_IN_LLVM_12 1
#  endif
#  define MSTD_INTRODUCED_IN_LLVM_12_ATTRIBUTE                                                                 \
...
#define MSTD_AVAILABILITY_HAS_NEW_SYNC MSTD_INTRODUCED_IN_LLVM_22
#define MSTD_AVAILABILITY_NEW_SYNC MSTD_INTRODUCED_IN_LLVM_22_ATTRIBUTE
...
#if !defined(MSTD_COMPILER_GCC) && !defined(_WIN32)
#  define MSTD_AVAILABILITY_HAS_ADDITIONAL_IOSTREAM_EXPLICIT_INSTANTIATIONS_1 MSTD_INTRODUCED_IN_LLVM_12
#else
#  define MSTD_AVAILABILITY_HAS_ADDITIONAL_IOSTREAM_EXPLICIT_INSTANTIATIONS_1 0
#endif

// This controls the availability of floating-point std::to_chars functions.
// These overloads were added later than the integer overloads.
#define MSTD_AVAILABILITY_HAS_TO_CHARS_FLOATING_POINT MSTD_INTRODUCED_IN_LLVM_14
#define MSTD_AVAILABILITY_TO_CHARS_FLOATING_POINT MSTD_INTRODUCED_IN_LLVM_14_ATTRIBUTE

// This controls whether the library claims to provide a default verbose
// termination function, and consequently whether the headers will try
// to use it when the mechanism isn't overriden at compile-time.
#define MSTD_AVAILABILITY_HAS_VERBOSE_ABORT MSTD_INTRODUCED_IN_LLVM_15
#define MSTD_AVAILABILITY_VERBOSE_ABORT MSTD_INTRODUCED_IN_LLVM_15_ATTRIBUTE
...
#define MSTD_AVAILABILITY_HAS_PMR MSTD_INTRODUCED_IN_LLVM_16
#define MSTD_AVAILABILITY_PMR
...
#define MSTD_AVAILABILITY_HAS_INIT_PRIMARY_EXCEPTION MSTD_INTRODUCED_IN_LLVM_18
#define MSTD_AVAILABILITY_INIT_PRIMARY_EXCEPTION MSTD_INTRODUCED_IN_LLVM_18_ATTRIBUTE
...
#define MSTD_AVAILABILITY_HAS_PRINT MSTD_INTRODUCED_IN_LLVM_18
#define MSTD_AVAILABILITY_PRINT MSTD_INTRODUCED_IN_LLVM_18_ATTRIBUTE

// This controls the availability of the C++20 time zone database.
// The parser code is built in the library.
#define MSTD_AVAILABILITY_HAS_TZDB MSTD_INTRODUCED_IN_LLVM_19
#define MSTD_AVAILABILITY_TZDB MSTD_INTRODUCED_IN_LLVM_19_ATTRIBUTE
...
#define MSTD_AVAILABILITY_HAS_BAD_FUNCTION_CALL_KEY_FUNCTION MSTD_INTRODUCED_IN_LLVM_19
#define MSTD_AVAILABILITY_BAD_FUNCTION_CALL_KEY_FUNCTION MSTD_INTRODUCED_IN_LLVM_19_ATTRIBUTE
#define MSTD_AVAILABILITY_HAS_BAD_EXPECTED_ACCESS_KEY_FUNCTION MSTD_INTRODUCED_IN_LLVM_19
#define MSTD_AVAILABILITY_BAD_EXPECTED_ACCESS_KEY_FUNCTION MSTD_INTRODUCED_IN_LLVM_19_ATTRIBUTE

// This controls the availability of floating-point std::from_chars functions.
// These overloads were added later than the integer overloads.
#define MSTD_AVAILABILITY_HAS_FROM_CHARS_FLOATING_POINT MSTD_INTRODUCED_IN_LLVM_20
#define MSTD_AVAILABILITY_FROM_CHARS_FLOATING_POINT MSTD_INTRODUCED_IN_LLVM_20_ATTRIBUTE

// This controls whether `std::__hash_memory` is available in the dylib, which
// is used for some `std::hash` specializations.
#define MSTD_AVAILABILITY_HAS_HASH_MEMORY MSTD_INTRODUCED_IN_LLVM_21
...
#define MSTD_AVAILABILITY_HAS_BAD_FUNCTION_CALL_GOOD_WHAT_MESSAGE MSTD_INTRODUCED_IN_LLVM_21
// No attribute, since we've had bad_function_call::what() in the headers before

// Define availability attributes that depend on both
// MSTD_HAS_EXCEPTIONS and MSTD_HAS_RTTI.
#if !MSTD_HAS_EXCEPTIONS || !MSTD_HAS_RTTI
#  undef MSTD_AVAILABILITY_HAS_INIT_PRIMARY_EXCEPTION
#  undef MSTD_AVAILABILITY_INIT_PRIMARY_EXCEPTION
#  define MSTD_AVAILABILITY_HAS_INIT_PRIMARY_EXCEPTION 0
#  define MSTD_AVAILABILITY_INIT_PRIMARY_EXCEPTION
#endif

#endif // MSTD_CONFIGURATION_AVAILABILITY_HPP
